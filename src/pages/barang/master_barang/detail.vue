    ...
    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6 w-[40%]">
      ...
      <div class="space-y-2">
        ...
        <div>
          ...
          <span class="text-sm text-gray-800">{{ data_barang.single_data_barang.description_category }}</span>
        </div>
        ...
        <div>
          ...
          <span class="text-sm text-gray-800">{{ data_barang.single_data_barang.description_merek }}</span>
        </div>
        ...
        <div>
          ...
          <span class="text-sm text-gray-800">{{ data_barang.single_data_barang.description_location }}</span>
        </div>
