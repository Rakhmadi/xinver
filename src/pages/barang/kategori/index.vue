...
let order_by = ref('tb_category.id')
...
watch([search,order_by,order_by_desc],()=>{
    data_barang.getDataKategori(search.value,false,order_by_desc.value,order_by.value)
})
...
<template>
    <h1 class="text-xl font-semibold text-[#2d354f] mb-4">List Data Kategori</h1>
    <div class="flex flex-row justify-between mb-4">
        <div class="flex felx-row gap-2 items-center w-full justify-between">
            <div class="flex flex-row items-center gap-2">
                <input v-model="search" type="text" placeholder="Cari Kategori" class="w-[250px] px-2 py-1 text-md bg-[#e4edff] border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#2563EB] focus:border-[#2563EB]">
                <select v-model="order_by" class="w-[300px] px-2 py-1 text-md bg-[#e4edff] border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#2563EB] focus:border-[#2563EB]">
                    <option value="tb_category.id" selected>Select</option>
